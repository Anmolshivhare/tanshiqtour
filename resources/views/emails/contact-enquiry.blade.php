                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:640px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding:28px;">
                            <h1 style="margin:0 0 10px;font-size:24px;line-height:1.3;color:#111827;">New Contact Enquiry</h1>
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#4b5563;">A visitor submitted the contact form on {{ $companyName }}.</p>

                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;">
                                <tr>
                                    <td style="padding:12px;border:1px solid #e5e7eb;background:#f9fafb;font-weight:bold;width:150px;">Name</td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:12px;border:1px solid #e5e7eb;">{{ $enquiry->subject ?? 'Contact form enquiry' }}</td>
                                </tr>
                            </table>

                            <div style="margin-top:24px;">
                                <p style="margin:0 0 8px;font-weight:bold;color:#111827;">Message</p>
                                <div style="padding:16px;background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;line-height:1.6;white-space:pre-line;">{{ $enquiry->message }}</div>
                            </div>
                        </td>
                    </tr>
                    <tr>
