...
@section('title')
    {{ __('labels.create_page', ['action' => __('labels.role')]) }}
@endsection
    ...
    <div class="row role-page-main-section">
        <div class="col-12">
            <div class="flex-row-reverse gap-4 pb-2 mb-3 d-flex justify-content-end align-items-center">
                <h1 class="mb-0 page-title"> {{ __('labels.create_page', ['action' => __('labels.role')]) }}</h1>
            </div>
        </div>
                                                            ...
                                                            <div class="form-check role-child-checkbox position-relative p-0 rounded-2">
                                                                <label
                                                                    ...
                                                                    <input type="checkbox"
                                                                        ...
                                                                        value="{{ $child->id }}" data-parent-id="{{ $category->id }}">
