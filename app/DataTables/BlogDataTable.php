...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) use ($user) {
                $editRoute   = $user->can('blog-edit')   ? route('admin.blogs.edit',    encrypt($row->id)) : '';
                $deleteRoute = $user->can('blog-delete') ? route('admin.blogs.destroy', encrypt($row->id)) : '';
                $viewRoute   = $user->can('blog-show')   ? route('admin.blogs.show',   encrypt($row->id)) : '';
    ...
    {
        $userCreate = $this->user->can('blog-create');
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('author_id')->title('Author')->addClass('text-center'),
